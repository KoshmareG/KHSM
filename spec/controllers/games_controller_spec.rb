...
RSpec.describe GamesController, type: :controller do
  ...
  context 'Usual user' do
    ...
    it 'forbids the user to watch align game' do
      alian_game = FactoryBot.create(:game_with_questions)

      get :show, id: alian_game.id
    ...
    it 'allows the user to take money' do
